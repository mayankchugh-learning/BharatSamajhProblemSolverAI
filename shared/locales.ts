...
const INDIA_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask BharatSolve AI",
  ...
  shareTitle: "BharatSolve AI — Solve Life's Challenges With Indian Wisdom & AI",
  ...
  faq: [
    { q: "What is BharatSolve AI?", a: "BharatSolve AI is an AI-powered platform that helps Indians solve real-life challenges including family dynamics, career growth, relationships, and social situations. It provides culturally aware, empathetic solutions that understand Indian values and traditions." },
    { q: "Which languages does BharatSolve AI support?", a: "BharatSolve AI supports 12 Indian languages: Hindi, Hinglish, English, Tamil, Telugu, Bengali, Marathi, Gujarati, Kannada, Malayalam, Punjabi, and Odia." },
    { q: "How much does BharatSolve AI cost?", a: "Start with a free 1-month trial — no credit card required. After the trial, the subscription is just ₹499/month. Earn free months through our referral program." },
    ...
    { q: "Can BharatSolve AI help with family problems?", a: "Yes! It's specially designed for Indian family dynamics — joint families, in-law relationships, marriage concerns, parenting challenges, and elder care." },
    { q: "How is this different from ChatGPT?", a: "Unlike generic AI, BharatSolve AI is deeply tuned for Indian cultural context — joint family dynamics, workplace culture, regional social norms." },
  ],
...
const SINGAPORE_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveSG AI",
  ...
  shareTitle: "SolveSG AI — Solve Life's Challenges With Singapore Smarts & AI",
  ...
  faq: [
    { q: "What is SolveSG AI?", a: "SolveSG AI is an AI-powered platform that helps Singaporeans solve real-life challenges including work-life balance, housing, career growth, and multicultural family dynamics." },
    { q: "Which languages does SolveSG AI support?", a: "English, Mandarin, Malay, Tamil, and Singlish. Converse naturally in your preferred language." },
    { q: "How much does SolveSG AI cost?", a: "Free 1-month trial, then S$15/month. Earn free months through referrals." },
    ...
    { q: "Can SolveSG AI help with HDB and housing issues?", a: "Yes! It understands BTO applications, resale flat decisions, renovation planning, and neighbour relations." },
    { q: "How is this different from ChatGPT?", a: "SolveSG AI is tuned for Singapore's context — multicultural dynamics, local work culture, HDB living, and Singaporean values." },
  ],
...
const HONG_KONG_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveHK AI",
  ...
  descriptionPlaceholder: "Share the full picture. We're listening...",
  shareTitle: "SolveHK AI — Solve Life's Challenges With Hong Kong Grit & AI",
  ...
  faq: [
    { q: "What is SolveHK AI?", a: "An AI platform that helps Hong Kongers solve real-life challenges including housing pressures, career growth, relationships, and family dynamics." },
    { q: "Which languages does SolveHK AI support?", a: "English, Cantonese, and Mandarin." },
    { q: "How much does SolveHK AI cost?", a: "Free 1-month trial, then HK$99/month. Earn free months through referrals." },
    ...
    { q: "Can SolveHK AI help with housing issues?", a: "Yes! Tiny flat living, subdivided units, landlord issues, and rent-vs-buy decisions." },
    { q: "How is this different from ChatGPT?", a: "SolveHK AI is tuned for Hong Kong — bilingual dynamics, local work culture, housing pressures, and HK values." },
  ],
...
const JAPAN_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveJP AI",
  ...
  shareTitle: "SolveJP AI — Solve Life's Challenges With Japanese Wisdom & AI",
  ...
  faq: [
    { q: "What is SolveJP AI?", a: "An AI platform helping people in Japan solve life challenges — workplace dynamics, family expectations, relationships — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveJP is tuned for Japanese cultural context — understanding honne/tatemae, workplace hierarchy, and social harmony." },
  ],
...
const CHINA_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveCN AI",
  ...
  shareTitle: "SolveCN AI — Solve Life's Challenges With Chinese Wisdom & AI",
  ...
  faq: [
    { q: "What is SolveCN AI?", a: "An AI platform that helps people in China solve life's challenges — career pressure, family expectations, relationships — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveCN is tuned for Chinese cultural context — guanxi, face culture, family obligations, and work pressures." },
  ],
...
const US_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveUS AI",
  ...
  shareTitle: "SolveUS AI — Solve Life's Challenges With Smart AI",
  ...
  faq: [
    { q: "What is SolveUS AI?", a: "An AI platform that helps Americans solve real-life challenges — career, family, finances, relationships — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveUS provides culturally-aware advice tuned for the American experience — diverse backgrounds, regional differences, and local norms." },
  ],
...
const UK_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveUK AI",
  ...
  shareTitle: "SolveUK AI — Solve Life's Challenges With British Insight & AI",
  ...
  faq: [
    { q: "What is SolveUK AI?", a: "An AI platform helping UK residents solve life challenges — work, housing, family, finances — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveUK is tuned for British culture — workplace etiquette, housing market, NHS, and social norms." },
  ],
...
const KOREA_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveKR AI",
  ...
  descriptionPlaceholder: "Share your situation in detail...",
  shareTitle: "SolveKR AI — Solve Life's Challenges With Korean Wisdom & AI",
  ...
  faq: [
    { q: "What is SolveKR AI?", a: "An AI platform helping Koreans solve life challenges — workplace stress, family expectations, relationships — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveKR is tuned for Korean cultural context — nunchi, jeong, hierarchy, and societal pressure." },
  ],
...
const UAE_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveUAE AI",
  ...
  descriptionPlaceholder: "Share the full picture. We're here to help...",
  shareTitle: "SolveUAE AI — Solve Life's Challenges With UAE-Smart AI",
  ...
  faq: [
    { q: "What is SolveUAE AI?", a: "An AI platform that helps UAE residents — both locals and expats — solve life challenges with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveUAE is tuned for UAE context — expat life, Emirati customs, business culture, and visa complexities." },
  ],
...
const AUSTRALIA_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveAU AI",
  ...
  shareTitle: "SolveAU AI — Solve Life's Challenges With Aussie Smarts & AI",
  ...
  faq: [
    { q: "What is SolveAU AI?", a: "An AI platform helping Australians solve life challenges — housing, career, family, finances — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveAU is tuned for Australian context — housing market, workplace culture, healthcare system, and local norms." },
  ],
...
const GERMANY_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveDE AI",
  ...
  shareTitle: "SolveDE AI — Solve Life's Challenges With German Precision & AI",
  ...
  faq: [
    { q: "What is SolveDE AI?", a: "An AI platform helping people in Germany solve life challenges — bureaucracy, career, housing, family — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveDE is tuned for German context — bureaucratic processes, workplace culture, housing market, and social systems." },
  ],
...
const BRAZIL_CONFIG: LocaleConfig = {
  ...
  problemDialogTitle: "Ask SolveBR AI",
  ...
  shareTitle: "SolveBR AI — Solve Life's Challenges With Brazilian Spirit & AI",
  ...
  faq: [
    { q: "What is SolveBR AI?", a: "An AI platform helping Brazilians solve life challenges — career, family, finances, education — with culturally aware solutions." },
    ...
    { q: "How is this different from ChatGPT?", a: "SolveBR is tuned for Brazilian context — jeitinho, family culture, economic realities, and local social norms." },
  ],
